...
/*  $Id: connect_misc_impl.hpp 632096 2021-05-26 16:43:24Z sadyrovr $
 * ===========================================================================
 *
...
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_pk_free);
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_pk_init);
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_pk_parse_key);
...
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_ssl_conf_own_cert);
...
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_x509_crt_free);
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_x509_crt_init);
NCBI_EXPORT_FUNC_DECLARE(XCONNECT, mbedtls_x509_crt_parse);
